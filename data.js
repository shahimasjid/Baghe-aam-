// data.js - Complete Configurations, 48 Prizes, Multi-Language Seerat Hub & Initial Models
...
window.INITIAL_STUDENTS = [
  {
    ...
    prize: "1st Prize - HP Core i5 Laptop",
    marks: 96,
    status: "Prize Winner",
    attendance: "Present",
    feedback: "",
...
window.INITIAL_FACULTIES = [
  ...
  {
    id: "FAC-102",
    name: "Moulana Abdul Quddus",
    email: "quddus@madarsa.org",
    phone: "9876543211",
    dept: "Seerat & Islamic History",
    status: "Pending",
    role: "faculty",
    assignedHall: "Hall B (Girls Wing)"
  }
];

// Multi-Language 500+ Words Seerat Hub Text
window.SEERAT_COMPREHENSIVE_TEXT = {
  ...
  ar: {
    ...
    sons: "القاسم (وبه كني أبو القاسم)، عبد الله (الطيب الطاهر)، وإبراهيم (من مارية القبطية).",
...
window.INITIAL_NOTICES = [
  ...
  { id: 2, title: "Participation Certificates Available", date: "Awards", desc: "All enrolled candidates can now generate and print verified participation certificates featuring Hadith." },
